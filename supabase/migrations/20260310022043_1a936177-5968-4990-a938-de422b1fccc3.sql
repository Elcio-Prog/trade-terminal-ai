CREATE TABLE IF NOT EXISTS public.continuous_renko_feature_vectors (
    ...
    UNIQUE (base_symbol, source_timeframe, brick_size, ts_reference, feature_set_version)
);

CREATE INDEX IF NOT EXISTS idx_continuous_renko_feature_vectors_lookup
    ON public.continuous_renko_feature_vectors (base_symbol, source_timeframe, brick_size, ts_reference DESC);
