    ...
    Tables: {
      ...
      ml_training_data_features: {
        Row: {
          ...
          ema200: number | null
          ema21: number | null
          ema21_200_dist: number | null
          ema9: number | null
          ema9_21_dist: number | null
          future_return_10: number | null
          future_return_3: number | null
          future_return_5: number | null
          high: number | null
          id: number | null
          liquidity_zone_center: string | null
          liquidity_zone_distance: string | null
          liquidity_zone_id: string | null
          liquidity_zone_strength: string | null
          low: number | null
          lower_wick: number | null
          macd: number | null
          macd_hist: number | null
          ...
          open: number | null
          order_flow_imbalance: string | null
          price: number | null
          price_ema200_dist: number | null
          range: number | null
          regime_label: string | null
          relative_volume: string | null
          renko_brick_size: string | null
          renko_dir: string | null
          renko_streak: string | null
          renko_strength: string | null
          return_1: number | null
          return_3: number | null
          return_5: number | null
          rsi: number | null
          ...
          volume_mean: string | null
          vwap: number | null
          vwap_lower_1: string | null
          vwap_lower_2: string | null
          vwap_position: string | null
          vwap_std: string | null
          vwap_upper_1: string | null
          vwap_upper_2: string | null
      ...
      ml_training_data_mtf: {
        Row: {
          ...
          created_at: string | null
          distance_ema200_15m: number | null
          distance_ema200_1h: number | null
          distance_ema200_30m: number | null
          distance_ema200_5m: number | null
          distance_vwap_pct: number | null
          distance_vwap_points: number | null
          ema200: number | null
          ema200_15m: number | null
          ema200_1h: number | null
          ema200_30m: number | null
          ema200_5m: number | null
          ema21: number | null
          ema21_200_dist: number | null
          ema50_15m: number | null
          ema50_1h: number | null
          ema50_30m: number | null
          ...
          momentum_20: number | null
          open: number | null
          open_15m: number | null
          open_1h: number | null
          open_30m: number | null
          open_5m: number | null
          order_flow_imbalance: string | null
          price: number | null
          price_ema200_dist: number | null
          ...
          trend_5m: number | null
          trend_strength_15m: number | null
          trend_strength_1h: number | null
          trend_strength_30m: number | null
          trend_strength_5m: number | null
          ts_ref: string | null
          upper_wick: number | null
          volume: number | null
